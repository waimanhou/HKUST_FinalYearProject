	...
	<div data-role="content">
		<?php
			...
			foreach($obj['curl'] as $key=>$val){ 
				...
				echo	'<table align="center"><tr><td valign="top" align="middle">';
				echo    '<img id="profilePic" src="'.profilePicUrl.$val['profilePic'].'" width="100" height="100">';
				if($profileUid==$t->id())
					echo	'<input type="file" id="file" name="file"/><a href="#" class="regular" onclick="ajaxFileUpload();">Upload</a>';
				echo	'</td></tr></table><table style="padding:0px 0px 0px 30px;" align="center">';
				//About
				...
				echo 	'<tr><td><br/></td><td><br/></td></tr><br/>';
				//Basic Info
